    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        ...
        SwingWorker<Response, Void> worker = new SwingWorker<>() {
            ...
            protected Response doInBackground() {
                if (!isEdit) {
                    return contatoController.criar(dto);
                } else {
                    return contatoController.alterar(originalName, dto);
                }
            }
            ...
            protected void done() {
                try {
                    ...
                    if (response != null && response.getStatus() == StatusResponse.OK) {
                        JOptionPane.showMessageDialog(Form_Cadastro.this, "Dados gravados com sucesso!");
                        ...
                        JOptionPane.showMessageDialog(Form_Cadastro.this, response.getTitulo() + ": " + response.getMensagemErro());
                    }
                } catch (InterruptedException ex) {
                    JOptionPane.showMessageDialog(Form_Cadastro.this, "Erro ao gravar: " + ex.getMessage());
