            ...
            protected void done() {
                try {
                    ...
                    if (response != null && response.getStatus() == StatusResponse.OK) {
                        ...
                        JOptionPane.showMessageDialog(Form_Listagem.this, response.getTitulo() + ": " + response.getMensagemErro());
                    }
        ...
        SwingWorker<Response, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    Response response = get();
                    if (response != null && response.getStatus() == StatusResponse.OK) {
                        List<Contato> list = (List<Contato>) response.getData();
                        populateTable(list);
                    } else if (response != null) {
                        JOptionPane.showMessageDialog(Form_Listagem.this, response.getTitulo() + ": " + response.getMensagemErro());
                    }
                } catch (InterruptedException ex) {
                    JOptionPane.showMessageDialog(Form_Listagem.this, "Erro ao carregar dados: " + ex.getMessage());
                } catch (ExecutionException ex) {
                    JOptionPane.showMessageDialog(Form_Listagem.this, "Erro ao carregar dados: " + ex.getMessage());
                }
            }
